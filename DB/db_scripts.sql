...
-- ----------------------------
BEGIN;
INSERT INTO `plazas` VALUES ('1', '230_errores', '.230', '1'), ('2', '30', '.030', '1');
COMMIT;
...
CREATE TABLE `procesos` (
  ...
  `plaza` varchar(10) DEFAULT NULL,
  `path_dir` varchar(250) DEFAULT NULL,
  `filename` varchar(250) DEFAULT NULL,
  `header_tienda` varchar(10) DEFAULT '0',
  `longitud_ht` int(10) DEFAULT '0',
  `header_recepcion` varchar(10) DEFAULT '1200',
  `longitud_hr` int(10) DEFAULT '0',
  `articulo` varchar(10) DEFAULT '1212',
...
-- ----------------------------
BEGIN;
INSERT INTO `procesos` VALUES ('1', 'Recepcion sin Pedido', 'RECEPRSO', '\\.(\\d\\d\\d)', '/Users/sandrarivera/Desktop/Jasso/Proyectos/Git/Perl_Siete/archivos/RECEPRSO', '^MC(\\d\\d)(\\d\\d)(\\d\\d)(\\d\\d\\d\\d\\d)\\.(\\d\\d\\d)$', '^0000', '17', '^1200', '97', '^1212', '52', '0', '1', '/Users/sandrarivera/Desktop/Jasso/Proyectos/Git/Perl_Siete/archivos/RECEPRSO'), ('2', 'Recepcion CDC', 'RECEPCDC', '\\.(\\d\\d\\d)', '/Users/sandrarivera/Desktop/Jasso/Proyectos/Git/Perl_Siete/archivos/RECEPCDC', '^MC(\\d\\d)(\\d\\d)(\\d\\d\\d\\d)(\\d\\d\\d\\d)\\.(\\d\\d\\d)$', '^0000', '17', '^1200', '97', '^1212', '52', '0', '1', '/Users/sandrarivera/Desktop/Jasso/Proyectos/Git/Perl_Siete/archivos/RECEPCDC');
COMMIT;
