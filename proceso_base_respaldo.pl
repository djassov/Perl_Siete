...
if($sia==0)
{
  print "° NO est· el archivo de  información inicial !";
  print ERROR "\nmail \"ERROR Liquidaciones\" jlealvil\@SEM \<\<\_clave";
  print ERROR "\nPROCESO DE VALIDACI”N DE LIQUIDACIONES...";
...
{
  print "° No hay información v·lida en el archivo de información inicial !";
  print ERROR "\nmail \"ERROR Liquidaciones\" jlealvil\@SEM \<\<\_clave";
  print ERROR "\nPROCESO DE VALIDACI”N DE LIQUIDACIONES...";
...
#--------+       
  ...
  foreach $a(@archivos){
    ...
    print "\nLectura de archivo v·lido +$a+ +++++++++++++++++++ $indice-$indice2 TIENDA: $tienda_a_procesar[$indice][1]";
...
#--------+       
     ...
     print "\nAbre el archivo al que se concatenar· la liquidación... $indice-$indice2";
     ...
     print "\nCierra el archivo al que se concatenar· la liquidación... $indice-$indice2";
...
#--------+       
     ...
     if($abc==0)
     {
       print LOG "\n      No existe la carpeta de procesados, se crear· para la tienda: $tienda_a_procesar[$indice][1] ...";
